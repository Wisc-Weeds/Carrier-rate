...
all_data1 %>% 
  ...
  labs(y = "%",
       x = "",
       title = "Figure 1. Efficacy (%) of preemergence herbicides in soybeans at Arlington and Janesville, WI",
       subtitle = "Weed biomass reduction (%) and control (%) of common ragweed, giant ragweed and grass are pooled over carrier volume rate") +
  coord_flip() +
  scale_color_brewer(palette = "Dark2") +
  theme(legend.position = "none",
        plot.title = element_markdown(size = 12, hjust = 0.98),
